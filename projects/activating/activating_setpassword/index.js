//引入已经激活的首页的样式表
var $ = require('jquery');
require("../_stylesheets/activating.setpassword.less");
...
UI.ready(function() {
  ...
  var $form = $("#J_act_setpassword");
  $submitbutton = $('#J_act_setpassword_submit');
  var validator = $("#J_act_setpassword").validate(validateOptions);
